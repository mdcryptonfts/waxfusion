...
//contractName: mockstake

void mockstake::transfer_tokens(const name& user, const asset& amount_to_send, const name& contract, const std::string& memo){
 ...
 */
ACTION mockstake::dosomething(const name& some_name){
