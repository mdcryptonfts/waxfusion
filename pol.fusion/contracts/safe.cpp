...
uint128_t polcontract::safeAddUInt128(const uint128_t& a, const uint128_t& b){
  uint128_t sum;
...
uint64_t polcontract::safeDivUInt64(const uint64_t& a, const uint64_t& b){
  uint64_t result;
...
uint128_t polcontract::safeDivUInt128(const uint128_t& a, const uint128_t& b){
  uint128_t result;
